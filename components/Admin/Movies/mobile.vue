<template>
  <div id="adminMoviesMobile" v-if="isAdmin === true">
    <div>
    ...
    <div v-if="getMovies.length > 0">
      <v-card v-for="movie in getMovies" :key="movie._id">
        <table>
          <tr><td class="infoTitle">{{ $t('title') }}</td></tr>
          <tr><td class="infoText">{{ movie[siteLang].title }}</td></tr>
          <tr><td class="infoTitle">{{ $t('vote') }}</td></tr>
          <tr><td class="infoText">{{ movie.vote_average }}</td></tr>
          <tr><td class="infoTitle">{{ $t('releaseDate') }}</td></tr>
          <tr><td class="infoText">{{ movie.release_date }}</td></tr>
          <tr><td class="infoTitle">{{ $t('director') }}</td></tr>
          <tr><td class="infoText">{{ movie.director }}</td></tr>
        </table>
        <span class="infoTitle">{{ $t('overview') }}</span><br>
