<template>
  <button @click="scrollToTop(showAt) "id="topBtn" title="Go to top">
    <svg xmlns="http://www.w3.org/2000/svg" id="toTop" width="30" height="30" fill="currentColor" class="bi bi-caret-up-square" viewBox="0 0 16 16">
